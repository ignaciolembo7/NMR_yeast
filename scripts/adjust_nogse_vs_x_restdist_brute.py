...
for roi, color in zip(rois,palette):
    ...
    params = create_params(l_c_mode=dict(value=4.5, min=2.5, max=7.5, brute_step=0.25, vary=True),
                           sigma=dict(value=0.8, min=0.1, max=1.2, brute_step=0.1, vary=True),
                           M0=dict(value=2800.0, min=2500.0, max=3200.0, brute_step=100, vary=True),
                           )
