...
for roi, color in zip(rois,palette):
    ...
    model = lmfit.Model(nogse.fit_contrast_vs_g_free_mixtodist, independent_vars=["TE", "G", "N", "D0_1", "D0_2"], param_names=["alpha_1","M0_1","lc_mode_2","alpha_2","sigma_2","M0_2"])
    model.set_param_hint("M0_1", value=0.641, min=0, max = 1.0, vary = 1)
    #model.set_param_hint("M0_2", expr="1 - M0_1")
    model.set_param_hint("M0_2", value=0.29, min=0, max = 1.0, vary = 1)
    model.set_param_hint("lc_mode_2", value=2.0, min = 0.5, max = 10.0, vary = 1)
    model.set_param_hint("sigma_2", value=1.0, min = 0.01, max=2.0, vary = 1)
    model.set_param_hint("alpha_1", value=0.53, min = 0, max=1, vary = 0)
    model.set_param_hint("alpha_2", value=0.015, min = 0.0, max=1, vary = 1)
