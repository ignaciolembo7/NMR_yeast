...
folder = "globalfit_M0_tc_alpha_contrast_vs_g_mixto_rest"
A0 = "con_A0"
...
params.add(f'tc1', value=2.2, min=0.1, max=15.0, vary = 1)
...
for tnogse, color in zip(tnogses, palette):
    ...
    with open(f"{directory}/parameters_N={int(n)}.txt", "a") as a:
        print("roi",  " - tc1 = ", tc1_fit, "+-", tc1_error, file=a)
...
with open(f"../results_{file_name}/{folder}/{A0}/{roi}_parameters_vs_tnogse.txt", "a") as a:
    print(alpha1_fit, tc1_fit, tc1_error, alpha1_error, M01_fit, M01_error, tc2_fit, tc2_error, alpha2_fit, alpha2_error, M02_fit, M02_error, file=a)
