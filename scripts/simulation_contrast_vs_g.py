...
g_contrast = np.linspace(0.1, 10000, 2000)
#tnogses = np.linspace(0.3, 3.5, 1000)    
# Añadir rectas de pendiente tnogse/tc
tnogses = [1.0, 2.0, 2.5, 3.0, 5.0, 10.0, 15.0, 30.0, 45.0, 60.0, 100.0, 200.0, 300.0, 600.0] 
#tnogses = [17.5, 21.5, 25.0, 30.0, 35.0, 40.0]
tc_1 = 30.0 
alpha_1 = 0
D0_1 = 2.3e-12  # m2/ms
tc_2 = 10000.0
...
palette = sns.color_palette("tab20", len(tnogses)) 
