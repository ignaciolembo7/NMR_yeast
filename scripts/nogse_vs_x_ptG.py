...
for i, color in zip([[T_NOGSE, 125.0, N],[T_NOGSE, 350.0, N],[T_NOGSE, 425.0, N],[T_NOGSE, 500.0, N],[T_NOGSE, 800.0, N]], palette): # N=2
...
fig.tight_layout()
fig.savefig(f"../results_mousebrain_20200409/nogse_vs_x_ptG/{ROI}_NOGSEvsx_TNOGSE={T_NOGSE}_N={N}_ptG.png", dpi = 600)
fig.savefig(f"../results_mousebrain_20200409/nogse_vs_x_ptG/{ROI}_NOGSEvsx_TNOGSE={T_NOGSE}_N={N}_ptG.pdf")
plt.close(fig)
