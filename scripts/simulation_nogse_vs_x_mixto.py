...
folder = "simulation_nogse_vs_x_mixto"
...
directory = f"../results_{file_name}/{folder}/slice={slic}/tnogse={tnogse}_N={int(n)}_tc={tc}_alpha={alpha}_D0={D0}"
...
for g,color in zip(gs,palette):
    ...
    f = nogse.M_nogse_mixto(tnogse, g, n, x, tc, alpha, M0, D0)
    error = 0
